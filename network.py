...
class CNNBlock(nn.Module):
    def __init__(self, frame_number):
        ...
        self.conv_layer3 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(5, 5), stride=(2, 2))
        self.conv_layer4 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(3, 3))
        self.conv_layer5 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(3, 3))
    ...
    def forward(self, depth):
        ...
        ff = depth[:, :, :, 128:256]
        rr = depth[:, :, :, 256:]
        o1 = torch.cat((ll, ff, rr), dim=1) / 255.0

        o1 = self.conv_layer1(o1)
